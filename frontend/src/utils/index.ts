...
import { NIcon, NTag, NBadge } from 'naive-ui';
 ...
 * render online Tag
 * */
 const onlineTagColors = { color: '#3CB371', textColor: '#fff', borderColor: '#3CB371' };
 export function renderOnline(type = 'warning', text='OL',color: object = onlineTagColors) {
   return () =>
     h(
      NTag as any,
       {
 ...
 * render jump Tag
 * */
 const jumpTagColors = { color: '#4169E1', textColor: '#fff', borderColor: '#4169E1' };
 export function renderJump(type = 'warning', text='JP',color: object = jumpTagColors) {
   return () =>
     h(
      NTag as any,
       {
